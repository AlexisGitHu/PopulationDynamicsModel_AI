...
PRED_NEAR_PREY_POSITIVE_REWARD=-1
PRED_NEAR_ALLIES_NEGATIVE_REWARD=-0.3
PRED_NEAR_PREDATOR_POSITIVE_MODIFIER=1
PRED_NEAR_PREY_POSITIVE_MODIFIER=0.1
PRED_NEAR_ALLIES_POSITIVE_MODIFIER=0.3
PRED_LOWEST_ENERGY_MODIFIER=4

# PREYS BEHAVIOURS MODIFIER FOR REWARD FUNCTION
PREY_NEAR_PREDATOR_NEGATIVE_REWARD=-1
PREY_NEAR_PREY_POSITIVE_REWARD=-1
PREY_NEAR_ALLIES_NEGATIVE_REWARD=-0.3
PREY_NEAR_PREDATOR_POSITIVE_MODIFIER=1
PREY_NEAR_PREY_POSITIVE_MODIFIER=0.1
PREY_NEAR_ALLIES_POSITIVE_MODIFIER=0.3
PREY_LOWEST_ENERGY_MODIFIER=4



prey_behaviour = Agents.IntelligentBehaviour(1, (SIZE, SIZE), 0.08, DISCOUNT_FACTOR, LEARNING_RATE,PRED_NEAR_PREDATOR_NEGATIVE_REWARD,
                                             PRED_NEAR_PREY_POSITIVE_REWARD,PRED_NEAR_ALLIES_NEGATIVE_REWARD,PRED_NEAR_PREDATOR_POSITIVE_MODIFIER,
                                             PRED_NEAR_PREY_POSITIVE_MODIFIER,PRED_NEAR_ALLIES_POSITIVE_MODIFIER,PRED_LOWEST_ENERGY_MODIFIER)
predator_behaviour = Agents.IntelligentBehaviour(0, (SIZE, SIZE), 0.08, DISCOUNT_FACTOR, LEARNING_RATE,PREY_NEAR_PREDATOR_NEGATIVE_REWARD,
                                                 PREY_NEAR_PREY_POSITIVE_REWARD,PREY_NEAR_ALLIES_NEGATIVE_REWARD,PREY_NEAR_PREDATOR_POSITIVE_MODIFIER,
                                                 PREY_NEAR_PREY_POSITIVE_MODIFIER,PREY_NEAR_ALLIES_POSITIVE_MODIFIER,PREY_LOWEST_ENERGY_MODIFIER)
