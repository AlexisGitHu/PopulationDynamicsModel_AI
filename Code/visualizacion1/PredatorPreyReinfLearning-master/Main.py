...
if __name__ == '__main__':
    ...
    for i in range(1, numLearningIterations):
        ...
        coord_x = random.randint(0,1000)
        coord_y = random.randint(0,500)
        # coord_y = randrange(10)
        numAgents = grid.update(False, i)
        print('{"Iteration": %d, "Pred": %d, "prey": %d, "grass": %d, "avg. prey death age": %.2f, "avg. pred death age": %.2f, "coord_x":%d, "coord_y":%d}' % (i, numAgents[0], numAgents[1], numAgents[2], numAgents[3], numAgents[4], coord_x, coord_y))
